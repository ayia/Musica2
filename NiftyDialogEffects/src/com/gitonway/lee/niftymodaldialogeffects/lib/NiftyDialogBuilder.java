...
public class NiftyDialogBuilder extends Dialog implements DialogInterface {
    ...
    public NiftyDialogBuilder withCostumeColor(int colorString) {
      	mFrameLayoutCustomView.setBackgroundColor(colorString);
        return this;
    }
    ...
    public NiftyDialogBuilder itemsCallback(ListCallback callback) {
        ...
        listView.setOnItemClickListener(new OnItemClickListener() {
			...
			public void onItemClick(AdapterView<?> arg0, View arg1, int arg2,
					long arg3) {
				   listCallback.onSelection(null, arg1, arg2, null);
    ...
    public NiftyDialogBuilder items( Collection collection) {
    ...
    public NiftyDialogBuilder items( CharSequence... items) {
         this.items = items;
         if (items.length > 0) {
             final String[] array = new String[items.length];
             int i = 0;
    ...
    public interface ListCallback {
        void onSelection(NiftyDialogBuilder dialog, View itemView, int which, CharSequence text);
    }    
    public interface ListCallbackMultiChoice {
       
        boolean onSelection(NiftyDialogBuilder dialog, Integer[] which, CharSequence[] text);
    }
    public interface ListCallbackSingleChoice {
        boolean onSelection(NiftyDialogBuilder dialog, View itemView, int which, CharSequence text);
    }
}
